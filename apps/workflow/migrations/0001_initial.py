    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', django.contrib.postgres.fields.citext.CICharField(max_length=100)),
                ('description', models.TextField()),
                ('delta_time', models.DurationField(help_text='time delay between completion of parent task and star of current task')),
                ('status', models.PositiveIntegerField(choices=[(1, 'ONGOING'), (2, 'COMPLETED'), (0, 'UPCOMMING')])),
                ('assigned_to', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='tasks', to=settings.AUTH_USER_MODEL)),
                ('child_task', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parents', to='workflow.Task')),
                ('parent_task', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='childs', to='workflow.Task')),
            ],
        ),
        migrations.CreateModel(
            name='Workflow',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.PositiveIntegerField(choices=[(0, 'READ'), (1, 'READ_WRITE')])),
